            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed">
                        I am always excited to discuss research opportunities, collaborations, and innovative ideas in computational biology
                    </p>
                </motion.div>
                    ...
                    >
                        <motion.div variants={itemVariants}>
                            ...
                            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                                Whether you are interested in research collaboration, have questions about my work,
                                or want to discuss opportunities in computational structural biology, I would love to hear from you.
                            </p>
                        </motion.div>
